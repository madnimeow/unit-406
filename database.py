...
def init_db():
    ...
    firebase_client_email = get_secret("FIREBASE_CLIENT_EMAIL")
    firebase_client_id = get_secret("FIREBASE_CLIENT_ID")
    firebase_client_x509_cert_url = get_secret("FIREBASE_CLIENT_X509_CERT_URL")
    firebase_auth_uri = get_secret("FIREBASE_AUTH_URI") or "https://accounts.google.com/o/oauth2/auth"
    firebase_token_uri = get_secret("FIREBASE_TOKEN_URI") or "https://oauth2.googleapis.com/token"
    firebase_auth_provider_x509_cert_url = get_secret("FIREBASE_AUTH_PROVIDER_X509_CERT_URL") or "https://www.googleapis.com/oauth2/v1/certs"
